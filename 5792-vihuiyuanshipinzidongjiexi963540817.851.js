		...
		if (self != top) {
			...
			if (location.href.match(/\.163\..+?\/store/)) {} else {
				try {
					...
					function jxbvipobj() {
						let jxbtupiana = "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAkAAAAMCAMAAACHgmeRAAAABGdBTUEAALGPC/xhBQAAAAFzUkdCAK7OHOkAAAAbUExURX//AIH8BobyGoT/CZP/J4nxIIL5C5T8LJj0PW2hJpgAAAAeSURBVAjXY2BlY4QABiZGBiigNouVGQoYONhZIAAAEpYAdsB2b4AAAAAASUVORK5CYII=", jxbtupianb = "data:image/png;base64,", jxbtupianc = "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAQAAAAECAYAAACp8Z5+AAAAFUlEQVQImWPMPHPpPwMSYGJAA4QFAMZ5Aw4eXQtVAAAAAElFTkSuQmCC", jxbtupiand = "data:image/png;base64,";
						try {
						...
						async function videobfjhobj() {
							try {
								if (document.querySelector('video#江小白') == null) {} else {
									elevideo = document.querySelector('video#江小白');
									try {
						...
						const jxbvipjxstyle = 'style="width:100%;height:100%;border:none;outline:none;margin:0;padding:0;position:absolute;z-index:963540817;"', jxbvipjximg = 'marginwidth="0" marginheight="0" width="100%" height="100%" ' + jxbvipjxstyle, jxbvipjxidstyle = 'style="width:100%;height:100%;border:none;outline:none;margin:0;padding:0;position:absolute;z-index:963540817;background-color:black;display:flex;justify-content:center;align-items:center;flex-direction:column;font-size:xx-large;"', jxbvipjxstrongstyle = 'font-weight:bold;display:flex;justify-content:space-evenly;align-items:center;width:100%;max-width:80%;"', jxbvipjxyyy = '<div id="江小白" ' + jxbvipjxidstyle + '><div style="letter-spacing:2px;color:#f8964c;' + jxbvipjxstrongstyle + '><img src="' + jxbtupiand + '" style="width:80%;"></div><iframe id="江小白" data-ad="false" autoLoad="true" autoplay="autoplay" loading="lazy" allowtransparency="true" frameborder="0" scrolling="no" security="restricted" sandbox="allow-top-navigation allow-same-origin allow-forms allow-scripts" allowfullscreen="allowfullscreen" mozallowfullscreen="mozallowfullscreen" msallowfullscreen="msallowfullscreen" oallowfullscreen="oallowfullscreen" webkitallowfullscreen="webkitallowfullscreen" src="', jxbvipjxvideoa = '<video id="江小白" controls="controls" autoplay="autoplay" preload="none" name="media" style="width:100%;height:100%;background:black;" src="', jxbvipjxvideob = '" type="video/mp4"></video>';
						function jxqzsxobj() {
							try {
								if (document.querySelector("iframe#江小白")) {
									document.querySelector("div#江小白").innerHTML = '<img id="江小白" src="https://api.btstu.cn/sjbz/zsy.php" ' + jxbvipjximg + '>';
						...
						if (iqiyialiwaiobj) {} else if (pcliwaiobj || sjliwaiobj || jxjkobj || mmkjjtjobj || objj.match(/(?:isyour|miao101|douyin|kuaishou|douban|bilibili|acfun|douban|yinyuetai|kuwo|kugou|m1907|qq|xiami|migu|ximalaya|app-echo|1ting|lrts|haokan|baidu|wbdy|web3v|9ku)\./)) {
							...
							cssobj(':focus{outline:none;}963540817');
						...
						async function zdbt() {
							...
							if (document.querySelector("\u6c5f\u5c0f\u767d\u6807\u9898") != null) {
								if (document.title.match(/^[^：]+?：\s*?第.+?[部季集话部期]\s*?(?:[上下]\s*?)?$/) != null) {} else {
									try {
										...
										if (document.querySelector("\u6c5f\u5c0f\u767d\u624b\u673a\u7f51\u9875") != null) {
							...
							if (document.querySelector("\u6c5f\u5c0f\u767d\u7535\u8111\u7f51\u9875") != null) {
								if (window.innerHeight > 789) {} else {
									cssobj('ul#httpsvipul{height:345px;overflow:hidden auto!important;}963540817');
								}
							}
							setTimeout(() => {
								if (document.querySelector("\u6c5f\u5c0f\u767d\u81ea\u5b9a\u4e49\u63a5\u53e3") != null) {} else {
									localStorage.removeItem('\u6c5f\u5c0f\u767d\u81ea\u5b9a\u4e49\u63a5\u53e3');
								}(function() {
									...
									if (localStorage.getItem("objjbo") == '1') {
										...
										if (document.querySelector("\u6c5f\u5c0f\u767d\u7535\u8111\u7f51\u9875") != null) {
											ccc = '<span><a1 style="color:darkgreen">搜索</a1><a2 style="display:none">', fff = '<span><a1 style="color:darkgreen">小窗</a1><a2 style="display:none">', ggg = '</a2><a3 style="color:#2196F3;zoom:0.8;font-weight:bold;">\u27bd</a3><a4>', ee = '<span><a1 style="color:darkgreen">小窗</a1><a2 style="display:none">';
										} else {
									...
									if (document.querySelector("\u6c5f\u5c0f\u767d\u81ea\u5b9a\u4e49\u63a5\u53e3") == null) {
										https = httpsaobj.concat(httpsbobj);
									} else {
										try {
											httpsobj = httpsaobj.concat(JSON.parse(localStorage.getItem('\u6c5f\u5c0f\u767d\u81ea\u5b9a\u4e49\u63a5\u53e3')));
											https = httpsobj.concat(httpsbobj);
										} catch (e) {
											https = httpsaobj.concat(httpsbobj);
										}
									}
									cssobj('div.maomibtn ul>li#json,div.maomibtn ul>li#jkqhmsobjli,div#jjxxkka>span#sjzdwsjson{display:block!important;}963540817');
									zdbt();
									if (document.querySelector("\u6c5f\u5c0f\u767d\u7535\u8111\u7f51\u9875") != null) {
										...
										jsonnn.onclick = function() {
											jsonnniframe = document.querySelector('iframe#江小白[src^="https://"][src$="&metareferer=undefined"]');
											...
											if (jxbpcobj) {} else {
												...
												httpsvipli.onclick = function() {
													try {
														...
														let tctha = '<div id="江小白" ' + jxbvipjxstyle + '><img id="江小白" src="https://api.btstu.cn/sjbz/" ' + jxbvipjximg + '></img></div>';
														let tcthb = '<div id="江小白" ' + jxbvipjxstyle + '><img id="江小白" src="' + jxbimg + '" ' + jxbvipjximg + '></img></div>';
														try {
														...
														try {
															if (document.querySelector("\u6c5f\u5c0f\u767d\u7535\u8111\u7f51\u9875") != null) {
																...
																if (objj.indexOf('youku') > 0) {
																	...
																	jxbjxurl = obj.replace(/^https?:\/\/(?:t|ww)w\.(.+?html).*?$/, "http://www.$1");
																	...
																	if (document.querySelector("div#player_default video")) {
																		...
																		try {
																			cssobj('.teleplayPage__playerSection__left{height:' + localStorage.getItem("视频高度") + 'px!important;width:' + localStorage.getItem("视频宽度") + 'px!important;}img[id="江小白"]{left:0%;}');
																		} catch (err) {}
																	} else {}
															...
															} else {} if (document.querySelector("\u6c5f\u5c0f\u767d\u624b\u673a\u7f51\u9875") != null) {
																try {
														...
														function vipobj(vip) {
															setTimeout(function() {
																try {
																	if (document.querySelector('div#江小白>div>img[src^="data:image/"]')) {
																		document.querySelector('div#江小白>div>img[src^="data:image/"]').remove();
																	} else {}
																} catch (err) {}
															}, 5555);
																			...
																			if (jxb.match(new RegExp("^https:\/\/(?!.+?强制(?:弹[小大]窗|跳转|搜索))")) && !(jxb.match(new RegExp("(?:透明无接口|布米米|视频选集|米侠|Youtube|麻花影视|旋风视频)")))) {
																				...
																				if (jxb.match(new RegExp("透明无接口"))) {
																					try {
																						...
																						if (document.querySelector(vip)) {
																							document.querySelector(vip).innerHTML = '<div id="江小白" ' + jxbvipjxstyle + '><img id="江小白" src="https://ceo30.coding.net/p/ceo30/d/sjtp/git/raw/master/1.png" ' + jxbvipjximg + ' onclick="document.getElementById(\'jxbhttps\').click();"></img></div>';
																							jxqzsxobj()
																						} else {}
																					}
																...
																if (https[num].json == null || https[num].json == undefined || https[num].json == '' || https[num].json == '0' || https[num].json.match(new RegExp("(?:跳|窗|^\s*?(?<!开)关\s*?$)")) || localStorage.getItem("objjbo") != '1') {
																	...
																	byjxpd.byjxsbobj = function() {
																		try {
																			jxqzsxobj();
																			if (document.querySelector(vip)) {
																				document.querySelector(vip).innerHTML = '<div id="江小白" ' + jxbvipjxidstyle + '><div style="letter-spacing:2px;color:yellow;' + jxbvipjxstrongstyle + '><strong>解</strong><strong>析</strong><strong>失</strong><strong>败</strong></div></div>';
																			} else {}
																		} catch (e) {}
																	};
																	if (https[num].vip == null || https[num].vip == undefined || https[num].vip == '' || !https[num].vip.match(new RegExp("(?:跳|窗)"))) {
																		...
																		if (document.querySelector(vip)) {
																			document.querySelector(vip).innerHTML = '<div id="江小白" ' + jxbvipjxidstyle + '><div style="letter-spacing:2px;color:#f8964c;' + jxbvipjxstrongstyle + '><img src="' + jxbtupiand + '" style="width:80%;"></div></div>';
																			setTimeout(() => {
																				if (sessionStorage.getItem("失败执行") == '1') {
																					sessionStorage.removeItem('失败执行');
																				} else {
																					try {
																						if (document.querySelector("iframe#江小白") != null || document.querySelector("img#江小白") != null || document.querySelector("div#江小白>div>strong:first-child").innerText == '解') {} else {
																							byjxpd.byjxsbobj();
																							if (https[num].json == '333') {
																								...
																								setTimeout(function() {
																									try {
																										if (pcliwaiobj) {
																											if (document.querySelector("div#江小白>div").innerText.match(/失/)) {
																												if (sessionStorage.getItem("解析失败") != null) {
																													document.querySelector("div#江小白>div").innerHTML = sessionStorage.getItem("解析失败");
																													sessionStorage.removeItem('解析失败');
																												} else {
																													if (sessionStorage.getItem("失败接口") != null) {
																														document.querySelector("div#江小白>div").innerHTML = '<p style="text-align:center;">该→' + sessionStorage.getItem("失败接口") + '←无法访问</p>';
																														sessionStorage.removeItem('失败接口');
																													} else {
																														document.querySelector("div#江小白>div").innerHTML = '<p style="text-align:center;">该Json无法访问</p>';
																													}
																												}
																											} else {}
																										} else {}
																	...
																	try {
																		...
																		byjxpd.byjxpdobj = function() {
																			setTimeout(() => {
																				document.querySelector(vip).innerHTML = '<div id="江小白" ' + jxbvipjxidstyle + '><div style="letter-spacing:2px;color:yellow;' + jxbvipjxstrongstyle + '><strong>备</strong><strong>用</strong><strong>解</strong><strong>析</strong></div></div>';
																				jxqzsxobj();
																			}, 567);
																		};
																		byjxpd.byjxpeobj = function() {
																			setTimeout(() => {
																				if (document.querySelector("img#江小白") != null) {} else {
																					if (document.querySelector(vip)) {
																						document.querySelector(vip).innerHTML = '<div id="江小白" ' + jxbvipjxstyle + '><img id="江小白" src="https://www.dmoe.cc/random.php" ' + jxbvipjximg + '></img></div>';
																					} else {}
																					jxqzsxobj()
																				}
																			}, 456);
																		...
																		byjxpd.byjxpgobj = function() {
																			if (document.querySelector("江小白电脑网页") != null) {
																				...
																				videobfjhjsobj = setInterval(function() {
																					try {
																						if (document.querySelector('video#江小白') != null) {
																							videobfjhobj();
																							jxbvolumeaobj();
																							try {
																								document.querySelector("video#江小白").play();
																							} catch (err) {}
																							try {
																								qpobj(document.querySelector('#江小白:not(div):not(img)'));
																							} catch (err) {}
																							clearInterval(videobfjhjsobj);
																						} else {}
																					} catch (err) {}
									...
									if (jxbpcobj) {
										...
										try {
											...
											try {
												...
												sjqjpbzdylwaobj = /(?:M19|邦宁|网吧|B站)/i, sjyyyzdypbobj = /(?:PAR|虾米|地衣|吾吾|爱跟|老版|达人|[淘白][a-z0-9]|扫描|月亮|看剧|神马|酷看|久播|思[云念]|速云)/i, sjqjpbzdylwbobj = /(?:玻璃|四零|小蒋|学习|猪蹄|七彩|刺客|扫描|神马|白玉|依托|法克|垫片|依齐|江湖|乐多|思古|[三八][一二]|17云|1717|8090|哔哩|九八|CKP|OK|Youtube|和巴|[方文学提教]案|布米米|视频选集|透明.*?接口)/i;
														...
														try {
															if (obj.match(/^https?:\/\/v(?:-wb)?\.youku\.com\/v_show\/id_/)) {
																...
																if (document.querySelector("#player_default>xg-controls a").innerText.indexOf('完整') > 0) {
																	dnzddjobj("%c江小白-电脑-西瓜视频自动解析-01-工作中");
																} else {}
															} else if (obj.match(/^https?:\/\/www\.bilibili\.com\/bangumi\/play\//)) {
													...
													if (pcliwaiobj || ttbkjjliobj) {
														if (pcliwaiobj) {
															(function() {
																...
																try {
																	if (document.querySelector("#江小白:not(div):not(img)")) {
																		try {
																			if (!document.querySelector("img#江小白")) {
																				if (document.querySelector("iframe#江小白")) {
																					...
																					if (localStorage.getItem("videobfjhobj") == '0') {
																						videobfjhobj();
																						try {
																							qpobj(document.querySelector('video#江小白'));
																						} catch (err) {}
																					} else {}
																				}
																			} else {}
																						...
																						(function() {
																							try {
																								...
																								let sdjxyywzdqp_jiankong = setInterval(function() {
																									let sdjxyywzdqp_btn = document.querySelector("#江小白:not(div):not(img)");
																									if (sdjxyywzdqp_btn) {
																										try {
																											qpobj(document.querySelector('#江小白:not(div):not(img)'))
																										} catch (err) {}
